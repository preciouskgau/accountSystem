...
public class AccountTypeControllerTest {
   ...
   @Test
    public void create() throws Exception{
       ...
       verify(createAccountTypeFlow, times(1)).create(accountType);
       assertEquals(expectedResponse, mvcResult.getResponse().getContentAsString());
   }
   @Test
...
//        Account
//       \
//       \TypeDto accountType = new AccountTypeDto("PLAY", "The new Play account type name",
...
//    }
//    @Test
//    public void updateAccountTypeDbiMandatory() throws Exception{
